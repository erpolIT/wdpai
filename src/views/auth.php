    ...
    <div id="login-form" class="form-section active">
        ...
        <form id="loginForm" action="/login" method="post">
            ...
            <div>
                ...
                <input type="password" id="password-login" name="password" placeholder="Enter your password" autocomplete="off">
            </div>
            <div class="options">
                <label>
    ...
    <div id="register-form" class="form-section">
        ...
        <form id="registerForm" action="/register" method="post">
            ...
            <div>
                ...
                <input type="password" id="password-register" name="password" placeholder="Enter your password" autocomplete="off">
            </div>
        <div>
            ...
            <div class="options">
                <label>
                    <input type="checkbox" name="terms"> By creating an account, you agree to the Terms of use and Privacy Policy.
                </label>
            </div>
